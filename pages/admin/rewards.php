        ...
        <div class="modal-content" style="max-height:80vh; overflow-y:auto;">
            ...
            <form id="rewardForm" class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="rewardNameInput" class="form-input" placeholder="e.g., Free Coffee" required>
                </div>

                <div class="form-group">
                    <label for="rewardTypeInput">Reward Type:</label>
                    <select id="rewardTypeInput" class="form-select">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="expirationDateInput" class="form-input">
                </div>

                <div class="form-group">
                    <label for="pointsInput">Points Required / Awarded:</label>
                    <input type="number" id="pointsInput" class="form-input" placeholder="e.g., 100" min="0">
                </div>
